...
namespace BulkyBookWeb.Controllers
{
    ...
    {
        private readonly ICategory<Category> context;
        public CategoryController(ICategory<Category> context)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var category = await context.EditCategory((int)id);
        ...
        public async Task<IActionResult> Delete(int? id)
        {
           ...
           var category = await context.DeleteCategoryGet((int)id);
        ...
        public async Task<IActionResult> Delete(Category category)
        {
            ...
            if (!ModelState.IsValid)
            {
                bool status = await context.DeleteCategoryPost(category);
                if (status == false)
                {
